...
const BUILD = /* stencil-js-lib */ { hotModuleReplacement: false, hydratedSelectorName: "hydrated", prop: true, propChangeCallback: false, shadowDom: false, slotRelocation: true, updatable: true};
...
class DeButton {
    ...
    size = 'md';
    render() {
        return (hAsync("button", { key: '893160091a4308bf44090a91003359c262b4f3db', class: `de-button de-button--${this.size}` }, hAsync("slot", { key: '5838897d87ec10e74c8a28e3ae2867a7fa2c7a35' })));
    }
